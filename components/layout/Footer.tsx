        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-5">
              ...
              {/* TikTok */}
              <a href="https://tiktok.com/@tantucore" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#f0f0f0]/40 hover:text-[#a855f7] hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.5)] hover:scale-110 transition-all duration-300">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
