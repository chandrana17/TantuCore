  ...
  return (
    <section className="mt-48 grid grid-cols-1 md:grid-cols-12 gap-4">
      ...
      <div className="md:col-span-4 bg-primary p-12 flex flex-col justify-center text-on-primary">
        ...
        <a className="font-label text-[10px] uppercase tracking-widest border-b border-on-primary/30 pb-1 self-start hover:border-on-primary transition-colors" href="#">Explore Everything →</a>
      </div>
    </section>
  );
}
